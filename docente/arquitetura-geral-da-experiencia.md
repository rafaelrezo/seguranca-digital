...
**Decisão docente posterior — A10 e nova edição prospectiva (17 set. 2026):** aprovada a direção de reordenar A10–A31. A10 trata mitigação de risco de engenharia social e segurança física por verificação independente, autorização de visita, delimitação de área, acompanhamento e registro, em indústria didática nova. A11 tratará dados/classificação/DLP; A12, malware e endpoint; A13–A18 reservam aprofundamento em criptografia; A19–A22 reservam fundamentos OT, NIST SP 800-82r3, defesa em profundidade, avaliação situada de zero trust, ISA/IEC 62443, arquitetura e recuperação; A23–A31 reservam pentest e defesa. A [confrontação curricular](planejamento-24-encontros/confrontacao-nova-edicao-a10-a31.md) registra limites e distribuição; fichas futuras ainda dependem de detalhamento, não de uma matriz inteiramente classificada agora. A matriz industrial é incremental, com fatos e incertezas por fase. A08/A09 ministradas permanecem históricas; nova edição do início do curso será apoio prospectivo, sem reescrever entrega passada. Esta decisão supera os estados A10 pendente/rascunho registrados abaixo.

**Reconciliação NIST SP 800-30 Rev. 1 — 10 set. 2026:** por solicitação docente, A09 passa a ser resumo estruturado e aplicado da edição final mais recente disponível (setembro de 2012), substituindo a proposta inicial baseada na edição retirada de 2002. Oito temas: preparar; identificar fontes/eventos/vulnerabilidades/controles existentes; determinar verossimilhança e impacto; determinar risco; planejar resposta; comunicar; examinar evidências de controles; manter a avaliação. Figuras 3 e 5 redesenhadas em português, tabelas G-5/I-2 traduzidas e fontes localizadas. A matriz começa após a identificação, com sete vistas sincronizadas nos temas 2–8 e dezessete campos; separa iniciação/ocorrência, dano condicionado e verossimilhança geral. Preparação fornece horizonte de 30 dias, fontes e tratamento da incerteza. R01 deixa de ser automaticamente alto: sob hipótese H1 de iniciação moderada, dano condicionado alto e impacto alto, resulta moderado provisório. Não atribuir essa hipótese a E2. Resposta e verificação são aplicações complementares à avaliação, não etapas adicionais atribuídas à SP 800-30. Preservar seis riscos Nuvora, atividade com seis riscos identificados pela dupla na central de equipamentos, 3–4 páginas, 100 min (60T/40P), fechamento em A09 e A10 pendente. Esta decisão substitui a escala local de três níveis e a matriz de treze campos; não altera o histórico da A08.

**Sínteses e transferência na atividade A09 — 10 set. 2026:** o docente solicitou ideias-chave itemizadas em cada seção e uma atividade em novo cenário, com levantamento dos riscos pelos estudantes. Preservar as oito matrizes sincronizadas e o exemplo Nuvora para condução. A entrega passa a analisar uma central fictícia de empréstimo de equipamentos tecnológicos: seis riscos formulados pela dupla a partir de fatos fornecidos, matriz completa de treze campos, controles propostos, critérios de verificação e residual estimado. Nenhum risco da atividade vem preenchido. Não transportar resultados T1–T7/V1 da Nuvora como evidência do novo caso. Na ausência de execução, Resultado/limite registra não verificado e a verificação necessária. Atividade única, PDF de 3–4 páginas, até 2 h externas, 100 min (60T/40P) e fechamento em A09 preservados. Últimos 15 min demonstram a transferência para a nova atividade, sem fornecer uma linha pronta. Esta decisão supera a entrega anterior de mera consolidação da matriz Nuvora.
...
**Nome do caso — 10 set. 2026:** a pedido docente, o nome fictício vigente passa a **Nuvora**, substituindo ValeVerde em A08/A09 e nos insumos utilizados. O nome anterior foi interpretado como alusão à empresa Vale. Política e procedimento passam a PSI-NU-01 e PR-NU-01. Esta é uma alteração de identificação, sem mudança de cenário, setor, evidências, critérios ou atividades. Preservar versões históricas e âncoras para links distribuídos; usar o novo nome em produções futuras.

**Padrão temático aprovado — 10 set. 2026:** o docente aprovou a proposta de sínteses temáticas e solicitou sua aplicação à A08/A09 e às produções futuras. O AGENTS.md passa a exigir títulos temáticos, síntese itemizada, esquema relacional e aplicação curta, com explicação de estudo preservada. A continuidade reutiliza dados e decisões sem exigir enredo. A08 passa a dez temas e A09 a oito; política integral e documentos do caso ficam em consulta na mesma página. Preservar objetivos, atividade única, rubrica, 100 minutos, A08 50T/50P e A09 60T/40P. Os oito passos de SGSI ficam como checklist, sem segunda sequência de condução. A realização da A08 está confirmada pelo docente; esta reorganização é apoio de estudo posterior, sem alterar o histórico de execução. A aprovação supera a pendência editorial registrada abaixo.

**Relato docente e proposta editorial — 10 set. 2026:** o docente confirmou que realizou a A08 e solicitou análise de A08/A09 para melhorar o apoio à explicação no Pages, com pontos temáticos itemizados, ilustrações/esquemas concisos e menor dependência de enredo, preservando o material de estudo. A confirmação supera os estados anteriores de A08 não ministrada; não comprova checkpoints ou entregas individuais. A [proposta de síntese temática](planejamento-24-encontros/proposta-sintese-tematica-a08-a09.md) registra diagnóstico, exemplos por tema e redação sugerida para o AGENTS.md. **Decisão pendente:** adoção do padrão e reorganização das páginas. Esta etapa é de proposta, sem alteração do site, dos materiais históricos ou das regras do AGENTS.md. A versão exata usada na condução não foi identificada; a análise editorial usa as páginas locais vigentes no menu, sem reconstruir retrospectivamente a aula.

**Sínteses para condução e PDF da política — 8 set. 2026:** cada seção principal da A08 e os passos de aplicação recebem itens de ideias-chave antes do texto de apoio. Os itens apresentam conceitos e decisões, sem metainstruções docentes públicas. Preservar conteúdo de estudo, política e atividades. O download da política passa a PDF, conforme solicitação expressa; fonte em texto e gerador permanecem versionados. PDF é insumo da aula, não novo roteiro de atividade.

**Revisão integrada aprovada — 8 set. 2026:** aplicar os achados das revisões técnica e didática: manter A08/A09 em pedidos, publicações e manutenção do portal; R02 não herda projetos de engenharia ou operação industrial. A política PSI-VV-01 é referência contínua do percurso. Seções 4–6 constroem contexto/escopo, diretriz/papéis e objetivo uma única vez; seção 7 aplica esses registros à simulação e conclui medição/melhoria, com síntese dos oito passos. Selecionar e avaliar diretriz, mantendo-a quando adequada ou adaptando com justificativa; desdobramento operacional vai ao procedimento. Fornecer pedido S01 concreto e comparar acordo original sem autoridade com arranjo proposto/aprovação simulada, sem alegar execução. Riscos: A08 registra candidato/pergunta; A09 compara com critérios. Meta e indicador usam autorizações cujo prazo vigente venceu na data de corte, encerramento comprovado; prorrogação ainda válida fica fora do denominador. Diagramas distinguem empresa fornecedora externa de serviço dentro do escopo. Consolidar planos vigentes e preservar 100 minutos/50T50P e única entrega A09 de 3–4 páginas.

**Política de referência com alcance do SGSI — 8 set. 2026:** ampliar a A08 para apresentar, após a delimitação de escopo, uma política didática integral da ValeVerde. Abranger compromissos, liderança, riscos, objetivos, apoio, operação, avaliação e melhoria; distinguir política (5.2) do conjunto de requisitos 4–10 e dos planos, procedimentos e registros que os operacionalizam. Manter o escopo de pedidos digitais e manutenção; tratar arquivos e acesso como ilustrações breves, sem transformar política em instrução de manipulação de arquivos. A09 adapta uma diretriz da referência, sem exigir reproduzir a política inteira nem aumentar a entrega. Redistribuir a leitura nos mesmos 100 minutos e preservar o roteiro visual.

**Apoio visual ao roteiro do SGSI — 8 set. 2026:** executar a tarefa de tornar a seção 7 visual, representando relações de escopo, autoridade, decisão de acesso, medição e melhoria no mesmo caso. Substituir explicações repetidas por esquemas acompanhados de leitura curta, preservando os oito passos, referências, exemplos públicos, registros e checkpoints. Manter objetivos e 100 minutos. Excluir o arquivo da fila conforme solicitação docente.

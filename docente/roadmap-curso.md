...
| [A10 — engenharia social e segurança física](../docs/aulas/A10-engenharia-social-seguranca-fisica.md) | 40/60 | Explicar pretexto, impersonificação, urgência e entrada junto a outra pessoa; configurar e testar confirmação, zona, janela, acompanhamento e registro. | R10-01/R10-02, testes A–E, lacuna de *tailgating* e pergunta sobre dados acessíveis. **Publicada.** |

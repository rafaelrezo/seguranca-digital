# Histórico das revisões do plano A08

Registro preservado; as instruções de condução vigentes estão em plano-de-aula.md. Os adendos abaixo documentam estados anteriores à revisão integrada aprovada.
...
| 30–50 | 10/10 | Passos 1–2 com exemplos de escopo/papéis das seções 4–5 da aula. Produzir contexto/escopo; examinar a política PSI-VV-01 por finalidade, compromissos e relação com procedimentos; adaptar uma diretriz e conferir autoridade/recurso. |
...
**Política de referência — ampliação de 8 set. 2026:** seção 4.1 apresenta PSI-VV-01 v0.1 como proposta didática sem aprovação. Dez itens autorais cobrem finalidade/escopo, compromissos CIA/requisitos/melhoria, liderança, riscos, objetivos, apoio, proteção/operação, fornecedores/mudanças, incidentes/exceções e avaliação/melhoria. Correspondência 4–10 distingue orientação de implantação e evidência; não equivale a checklist integral de conformidade. Texto editável acompanha a página. Casos de arquivo e acesso são aplicações, não limites da política. Quadro de papéis passa a incluir recuperação, preparação e recursos.

Nos mesmos 20 minutos dos passos 1–2, fazer leitura seletiva da política e trabalhar uma adaptação. A leitura integral fica disponível para consulta. Não ler em voz alta todos os itens nem acrescentar atividade. A09 pede uma diretriz adaptada com justificativa, mantendo PDF de 3–4 páginas. Fontes institucionais ISO, UCL e LNCC reconsultadas; política ValeVerde é autoral e não transcreve documentos dessas organizações.

**Localização do Anexo A — 8 set. 2026:** a aula identifica explicitamente o Anexo A como parte da ISO/IEC 27001:2022, após a seção 10 e antes da bibliografia; fornece título no sumário em inglês e link da prévia. A política editável nomeia a norma na remissão. Sumário conferido diretamente na prévia SIST; não usar a paginação da versão redline como paginação universal. Âncora anterior preservada.

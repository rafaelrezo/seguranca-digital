...
| **A09 — Avaliar riscos com a NIST SP 800-30** | NIST SP 800-30 Rev. 1: preparar, conduzir, comunicar e manter; aplicação a resposta, evidência e residual | Professor constrói matriz de seis riscos por novas colunas, compara E1–E8, conduz plano de 12 h, avalia T1–T7 e apresenta V1 | Entrega A08–A09 em novo cenário de central de equipamentos: seis riscos levantados pela dupla, matriz com controles, verificação planejada e autoridade. Sem etapa de controles na A10 | 60/40 |

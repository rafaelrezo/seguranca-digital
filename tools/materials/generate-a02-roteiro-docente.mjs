...
const children = [
  ...
  H("Nível de apoio para a segunda aula",HeadingLevel.HEADING_2),
  P("Não espere que a turma descubra a rota, produza taxonomias ou escreva um ticket completo sem modelo. A URL http://127.0.0.1:3000/ftp/acquisitions.md é fornecida e executada primeiro pelo professor. A turma identifica campos diretamente observáveis; o professor constrói o primeiro encadeamento ativo–ameaça–fraqueza–vulnerabilidade–consequência; as duplas justificam e limitam as afirmações. Autonomia técnica não é critério nesta aula."),
  box("Progressão de apoio","Eu faço: professor executa e verbaliza a observação. Nós fazemos: turma constrói ativo e ameaça. Vocês fazem com apoio: duplas justificam fraqueza, vulnerabilidade, consequência, controle e reteste usando os pontos de partida do PDF.",C.blue),
  ...
  table(["Tempo/slide","Ação do professor","Participação e evidência"],[
    ["0–5 • Slide 1","retomar A01 e apresentar o documento entregue sem nomear a causa","fato: houve resposta 200; lacunas permanecem"],
    ["5–9 • Slide 2","explicar a competência da aula em quatro movimentos","turma reconta observar–nomear–decidir–validar"],
    ["9–14 • Slide 3","mostrar que 127.0.0.1 é o computador do estudante e explicar por que o alvo é local","URL base e limite do ambiente compreendidos"],
    ["14–24 • Slide 4","executar a URL fornecida e separar observado de inferido","método, caminho, status, tipo, ausência de login e uma hipótese"],
    ["24–31 • Slide 5","construir quatro ativos somente do Juice Shop","informação, arquivo, serviço e container ligados a funções"],
    ["31–39 • Slide 6","montar o exemplo ativo–ameaça–fraqueza–vulnerabilidade–consequência","turma indica onde começa a inferência"],
    ["39–44 • Slide 7","definir controle e diferenciar funções preventiva, detectiva, corretiva e recuperação","um exemplo de cada função no mesmo caso"],
    ["44–47 • Slide 8","votar em controle e exigir um reteste compatível","decisão com premissa e resultado esperado"],
    ["47–49 • Slide 9","ler a frase de registro e identificar cada trecho","modelo de ticket compreendido"],
    ["49–52 • Slides 10–11","apresentar prática e síntese; abrir o PDF na Etapa 1","duplas assumem papéis e localizam URL/comandos"],
  ],[1800,4850,3650]),
  H("Falas e perguntas úteis",HeadingLevel.HEADING_2),
  bullet("Slide 1: “O 200 é nossa evidência inicial. Que decisão ainda seria precipitada?”"),
  bullet("Slide 2: “Hoje não descobriremos uma falha; aprenderemos a explicar uma exposição conhecida.”"),
  bullet("Slide 3: “De quem é o computador representado por 127.0.0.1?”"),
  bullet("Slide 4: “Qual campo vocês conseguem apontar na tela, sem interpretar?”"),
  bullet("Slide 5: “Além do computador, que informação, arquivo e serviço têm valor?”"),
  bullet("Slide 6: “Em qual linha deixamos de observar e começamos a formular hipótese?”"),
  bullet("Slide 7: “Este controle tenta evitar, detectar, corrigir ou recuperar?”"),
  bullet("Slide 8: “Se a função do recurso for ___, escolhemos ___ e comprovamos por ___.”"),
